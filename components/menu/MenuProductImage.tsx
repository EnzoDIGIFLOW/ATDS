...
export default function MenuProductImage({
  ...
  useEffect(() => {
    return () => {
      ...
      if (preloadImageRef.current) preloadImageRef.current = null
    }
  }, [])
  
  // Précharger l'image pour le zoom
  useEffect(() => {
    if (imageUrl && enableZoom) {
      const img = new window.Image()
      img.src = imageUrl
      img.onload = () => {
        setZoomImageReady(true)
  ...
  const handleMouseEnter = () => {
    if (!enableZoom || !imagePath) return
  ...
  return (
    <>
      ...
      {/* Modal de zoom avec AnimatePresence */}
      <AnimatePresence>
          ...
          <>
            ...
            >
              <div className="relative">
                ...
                {/* Conteneur principal avec l'image préchargée */}
