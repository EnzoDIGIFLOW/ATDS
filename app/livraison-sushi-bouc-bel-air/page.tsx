...
// Import des vrais widgets utilisés dans la home page
...
const NosCreationsWithCart = dynamic(() => import('@/components/our-creation-section-with-cart'))
...
export default function LivraisonSushiBoucBelAir() {
  ...
  return (
    <>
      ...
      <section id="zone-livraison" className="py-12">
        <div className="max-w-6xl mx-auto px-4">
      ...
      {/* Section Nos Créations - Carousel comme dans la home */}
      <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <NosCreationsWithCart />
        </div>
      </section>
      ...
      {/* Section Instagram Feed - Widget officiel */}
      <section className="py-12 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-8">Suivez-nous sur Instagram</h2>
          <InstagramFeed />
        </div>
      </section>
